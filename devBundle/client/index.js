...
var client_1 = __webpack_require__(/*! ./client/ */ "./src/client/index.js");
...
/***/ "./src/client/build-create-component.js":
/*!**********************************************!*\
  !*** ./src/client/build-create-component.js ***!
  \**********************************************/
/*! no static exports found */
...
exports.hydrate = (function (_a) {
    var Component = _a.Component, classNames = _a.classNames, rootId = _a.rootId, _b = _a.helpers, helpers = _b === void 0 ? {} : _b;
    var $root = document.getElementById(rootId);
    if ($root && $root.children.length) {
        $root.replaceChild(Component({ classNames: classNames, helpers: helpers })[0], // todo
        $root.children[0] // todo
        );
    }
    else {
        $root.append(Component({ classNames: classNames, helpers: helpers })[0] //todo
        );
    }
    var _c = helpers.enqueueScript, _d = (_c === void 0 ? {} : _c).componentDidMountQueue, componentDidMountQueue = _d === void 0 ? [] : _d;
...
Object.defineProperty(exports, "__esModule", { value: true });
var build_create_component_1 = __webpack_require__(/*! ./build-create-component */ "./src/client/build-create-component.js");
exports.buildCreateComponent = build_create_component_1.buildCreateComponent;
var hydrate_1 = __webpack_require__(/*! ./hydrate */ "./src/client/hydrate.js");
